...
public class PlayerController : MonoBehaviour
{
	...
	[Tooltip("How fast the stamina drains")]
	[Range(0f, 1f)]
	...
	private void Move()
	{
		...
		else
		{
			...
			_stamina += StaminaGainRate * Time.deltaTime;
		};
	...
	{
		if (flashlight.enabled == _input.flashlight) return;
        
		
		flashlight.enabled = _input.flashlight;
	}
